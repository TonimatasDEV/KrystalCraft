package net.tonimatasdev.krystalcraft.integration;
...
public class GemCuttingStationRecipeCategory implements IRecipeCategory<GemCuttingStationRecipe> {
    ...
    public final static ResourceLocation TEXTURE = new ResourceLocation(KrystalCraft.MOD_ID, "textures/gui/gem_cutting_station_gui.png");
