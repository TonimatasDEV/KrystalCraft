...
public class CombiningStationScreen extends BaseScreen<CombiningStationMenu> {
    public CombiningStationScreen(CombiningStationMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
        super(pMenu, pPlayerInventory, pTitle, "combining_station");
    }
    ...
    protected void renderBg(GuiGraphics guiGraphics, float f, int i, int j) {
        ...
        GuiUtil.drawFire(guiGraphics, this.leftPos + 130, this.topPos + 37, this.menu.burnTime.get(), this.menu.burnTimeTotal.get());
    }
