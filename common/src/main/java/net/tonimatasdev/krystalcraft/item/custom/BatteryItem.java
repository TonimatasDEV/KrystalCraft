...
import net.tonimatasdev.krystalcraft.plorix.energy.impl.WrappedItemEnergyContainer;
import org.jetbrains.annotations.Nullable;

import java.util.List;

public class BatteryItem extends Item implements PlorixEnergyItem<WrappedItemEnergyContainer> {
