...
public class BlockEntityRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<GemCuttingBlockEntity>> GEM_CUTTING_STATION_BLOCK_ENTITY = BLOCK_ENTITIES.register("gem_cutting_block_entity", () -> BlockEntityType.Builder.of(GemCuttingBlockEntity::new, BlockRegistry.GEM_CUTTING_STATION.get()).build(null));
