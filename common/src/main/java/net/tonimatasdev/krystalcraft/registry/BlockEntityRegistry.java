...
public class BlockEntityRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<GemCuttingBlockEntity>> CUTTING_STATION_BLOCK_ENTITY = BLOCK_ENTITIES.register("cutting_station_block_entity", () -> BlockEntityType.Builder.of(GemCuttingBlockEntity::new, BlockRegistry.CUTTING_STATION.get()).build(null));
