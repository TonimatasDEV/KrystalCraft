...
//------------------------------------------------------------------------------------------------------------------Jade
    ...
    public static final RegistrySupplier<Item> JADE_HORSE_ARMOR = ITEMS.register("jade_horse_armor", () -> new HorseArmorItem(9, "jade", new HorseArmorItem.Properties().stacksTo(1)));
...
//-----------------------------------------------------------------------------------------------------------------Items
    ...
    public static final RegistrySupplier<Item> SET_WATER_BOTTLES = ITEMS.register("set_water_bottles", () -> new Item(new Item.Properties().durability(64)));
