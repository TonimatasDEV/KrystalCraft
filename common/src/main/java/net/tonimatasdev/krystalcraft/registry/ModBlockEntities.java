...
public class ModBlockEntities {
    ...
    public static final RegistryEntry<BlockEntityType<EnergyPipeBlockEntity>> ENERGY_PIPE_BLOCK_ENTITY = BLOCK_ENTITIES.register("energy_pipe", () -> RegistryHelpers.createBlockEntityType(EnergyPipeBlockEntity::new, ModBlocks.ENERGY_PIPE.get()));
}