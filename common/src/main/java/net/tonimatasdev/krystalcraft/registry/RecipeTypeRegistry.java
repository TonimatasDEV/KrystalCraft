...
public class RecipeTypeRegistry {
    ...
    public static final RegistrySupplier<RecipeType<CoalCombinerRecipe>> COAL_CRUSHER_TYPE = create("coal_crusher");
    public static final RegistrySupplier<RecipeType<CoalCombinerRecipe>> GEM_CUTTING_STATION_TYPE = create("gem_cutting_station");
