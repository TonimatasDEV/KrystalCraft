...
public class CrushingFactoryScreen extends HandledScreen<CrushingFactoryScreenHandler> {
    public static final Identifier TEXTURE = Identifier.of(KrystalCraft.MOD_ID, "textures/gui/crushing_factory.png");

    public CrushingFactoryScreen(CrushingFactoryScreenHandler handler, PlayerInventory inventory, Text title) {
