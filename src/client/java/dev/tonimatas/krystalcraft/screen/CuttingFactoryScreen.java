...
public class CuttingFactoryScreen extends HandledScreen<CuttingFactoryScreenHandler> {
    public static final Identifier TEXTURE = Identifier.of(KrystalCraft.MOD_ID, "textures/gui/cutting_factory.png");

    public CuttingFactoryScreen(CuttingFactoryScreenHandler handler, PlayerInventory inventory, Text title) {
