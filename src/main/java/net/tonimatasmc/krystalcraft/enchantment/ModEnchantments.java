...
import net.tonimatasmc.krystalcraft.enchantment.enchants.*;
...
public class ModEnchantments {
    ...
    public static RegistryObject<Enchantment> LIGHTNING_STRIKER =
            ENCHANTMENTS.register("lightning_striker", () -> new LightningStrikeEnchantment(
                    Enchantment.Rarity.VERY_RARE, EnchantmentCategory.WEAPON, EquipmentSlot.MAINHAND));

    public static RegistryObject<Enchantment> VENOM =
            ENCHANTMENTS.register("venom", () -> new VenomEnchantment(
                    Enchantment.Rarity.UNCOMMON, EnchantmentCategory.WEAPON, EquipmentSlot.MAINHAND));

    public static RegistryObject<Enchantment> LIFE_LEECH =
            ENCHANTMENTS.register("life_leech", () -> new LifeLeechEnchantment(
