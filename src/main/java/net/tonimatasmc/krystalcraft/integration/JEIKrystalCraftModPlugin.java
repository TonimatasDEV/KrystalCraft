...
public class JEIKrystalCraftModPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        List<CoalCombinerRecipe> recipesCoalCombiner = rm.getAllRecipesFor(CoalCombinerRecipe.Type.INSTANCE);
        registration.addRecipes(new RecipeType<>(CoalCombinerRecipeCategory.UID, CoalCombinerRecipe.class), recipesCoalCombiner);
    }
}